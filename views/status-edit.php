   ...
   printf($template, $_POST['status_id']);
      ...
      $template_status = '
        ...
        <form method="POST" class="item">
            ...
            <div class="p_25">
                <input type="text" placeholder="status" name="status" value="%s" required>
            </div>
            <div class="p_25">
...
}else if( $_POST['r'] == 'status-edit' && $_SESSION['role'] == 'Admin'
  && $_POST['crud'] == 'set' ) {
    ...
    $template = '<div class="container">
                    <p class="item  edit">Status <b>%s</b> ha sido editado</p>
                </div>
                <script>
                    window.onload = function() {
                      reloadPage("status")
