...
if( $_POST['r'] == 'movieserie-add' && $_SESSION['role'] == 'Admin' && !isset($_POST['crud']) ) {
  ...
  printf('
    ...
    <form method="POST" class="item">
      <div class="p_25">
          <input type="text" name="imdb_id" placeholder="Movie ID" required>
      </div>
      <div class="p_25">
      ...
      <div class="p_25">
          <input type="text" name="country" placeholder="países">
      </div>
      <div class="p_25">
          <input type="text" name="premiere" placeholder="premiere" required>
      </div>
      <div class="p_25">
          <input type="url" name="poster" placeholder="póster">
      </div>
      <div class="p_25">
          <input type="url" name="trailer" placeholder="tráiler">
      </div>
      <div class="p_25">
  ...
  ', $status_select);
} else if( $_POST['r'] == 'movieserie-add' && $_SESSION['role'] == 'Admin'
&& $_POST['crud'] == 'set' ) {
    ...
    $movieseries = $ms_controller->set($new_ms);

    $template = '<div class="container">
                    <p class="item  add">MovieSerie <b>%s</b> ha sido agregada</p>
                </div>
                <script>
