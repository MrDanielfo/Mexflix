     ...
     $role_user = ($user[0]['role'] == 'User' ) ? 'checked' : '';
      ...
      $template_user = '
        ...
        <form method="POST" class="item">
            ...
            <div class="p_25">
                <input type="email" placeholder="email" value="%s" disabled required>
                <input type="hidden" name="email" value="%s">
            </div>
            <div class="p_25">
                <input type="text" placeholder="name" name="name" value="%s" required>
            </div>
            <div class="p_25">
                <input type="text" placeholder="cumpleaños" name="birthday" value="%s" required>
            </div>
            <div class="p_25">
...
}else if( $_POST['r'] == 'user-edit' && $_SESSION['role'] == 'Admin'
  && $_POST['crud'] == 'set' ) {
    ...
    $template = '<div class="container">
                    <p class="item  edit">El Usuario <b>%s</b> ha sido editado</p>
                </div>
                <script>
                    window.onload = function() {
                      reloadPage("users")
